...
useEffect(() => {
    try {
      const fetchPost = async () => {
        ...
        console.log('fetched using effect',formData)
      };
...
console.log("setted in form",formData);
...
<div className='flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3'  >
    ...
    <Button type='button' gradientDuoTone='purpleToBlue' size='sm' onClick={handleUploadImage}
...
<ReactQuill theme='snow' placeholder='Write something..' className='h-72 mb-12' required onChange={(value) => setFormData(prev => ({ ...prev, content: value }))} value={formData.content || ''} />
